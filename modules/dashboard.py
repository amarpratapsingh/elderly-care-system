...
def run_dashboard_server(host: str = "0.0.0.0", port: int = 0) -> None:
    """Start dashboard server. Port 0 = auto-assign by OS."""
    import os
    
    # Allow override via env var, otherwise auto-assign with 0
    ...
    # Get the actual assigned port (if auto-assigned)
